...
public class AuthService {
  ...
  public UserDTO registerUser(RegistrationRequest registrationRequest) {
    ...
    if (userRepo.existsByEmail(registrationRequest.email().toLowerCase())) {
  ...
  public EmailStatusDTO changePass(UserDetails userDetails, ChangePassRequest passRequest) {
    ...
    userRepo.save(user);
    return new EmailStatusDTO(userDetails.getUsername(), "The password has been updated successfully");
  }
